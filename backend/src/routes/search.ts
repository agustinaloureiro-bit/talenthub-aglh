...
function expandedSearchTerms(query: string) {
  ...
  const extras: Record<string, string[]> = {
    ...
    operario: ["operaria", "produccion", "producción", "fabrica", "fábrica", "manufactura", "linea de produccion", "línea de producción", "auxiliar de produccion", "auxiliar de producción", "peon", "peón"],
    operaria: ["operario", "produccion", "producción", "fabrica", "fábrica", "manufactura", "linea de produccion", "línea de producción", "auxiliar de produccion", "auxiliar de producción", "peon", "peón"],
    fabrica: ["fábrica", "produccion", "producción", "manufactura", "industria", "planta industrial", "linea de produccion", "línea de producción"],
