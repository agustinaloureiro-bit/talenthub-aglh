...
const EQUIVALENT_TERMS: Record<string, string[]> = {
  ...
  enfermero: ["enfermera", "enfermeros", "enfermeras", "enfermeria", "auxiliar de enfermeria", "licenciado en enfermeria", "licenciada en enfermeria"],
  enfermera: ["enfermero", "enfermeros", "enfermeras", "enfermeria", "auxiliar de enfermeria", "licenciado en enfermeria", "licenciada en enfermeria"],
